...
function isWin(){
	...
	|| ((document.getElementById("B1").innerHTML == document.getElementById("B2").innerHTML) && (document.getElementById("B1").innerHTML == document.getElementById("B3").innerHTML))
	|| ((document.getElementById("A1").innerHTML == document.getElementById("A2").innerHTML) && (document.getElementById("A1").innerHTML == document.getElementById("A3").innerHTML))
	|| ((document.getElementById("A1").innerHTML == document.getElementById("B2").innerHTML) && (document.getElementById("A1").innerHTML == document.getElementById("C3").innerHTML))
	|| ((document.getElementById("C1").innerHTML == document.getElementById("B2").innerHTML) && (document.getElementById("C1").innerHTML == document.getElementById("A3").innerHTML))
	){
		return true;
	}
...
function play() {
	...
	var playerMark = ((whose_move()) ? "X" : "O");

	//alert(passEqualsConfPass);

	if(!myInput.value.match(validMoves)) {  
		alert("Invalid Move!")
		return
	}
	var myMove = document.getElementById(myInput.value);
	if( myMove.innerHTML != myMove.id){
		alert("Cell already played!");
		return;
	}           
	myMove.innerHTML = playerMark;


	if(isWin()){
		var winText = "Winner is: " + playerMark;
		alert(winText);
		reset_play();
	}
	...
	myInput.value = null;
	var playerMark = ((whose_move()) ? "X" : "O");
	document.getElementById("turn_info").innerHTML = "Turn for: <b>" + playerMark + "</b>"
	return;
}
